...
export default function Onboarding({ onDone }) {
  ...
  // Touch handlers para swipe izquierda/derecha
  ...
  function handleTouchEnd(e) {
    ...
    if (Math.abs(diff) < 30) return; // ignorar taps
    if (diff > 0) next();           // swipe izquierda → avanzar
    else if (idx > 0) setIdx(idx - 1); // swipe derecha → retroceder
  ...
  return (
    <div
      ...
      {/* Botón Omitir — no propaga el tap */}
      <button
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "20px 32px 0" }}>
        <img
          src={slide.img}
          alt=""
          style={{ width: "100%", maxWidth: 320, height: "auto", objectFit: "contain", pointerEvents: "none" }}
        />
      </div>

      {/* Contenido inferior */}
      <div style={{ padding: "0 32px 56px", textAlign: "center" }}>
        <div style={{
